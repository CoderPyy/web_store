...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			function underOne(pid){
				if(confirm("您确认下架这个商品吗？")){
					window.location.href="${ pageContext.request.contextPath }/adminProduct?method=updateByPflag&pid="+pid;
				}
							...
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<c:forEach items="${pb.list }" var="p" varStatus="vs">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="javascript:void(0)" onclick="underOne('${p.pid}')">
													<img src="${pageContext.request.contextPath}/images/i_del.gif" width="16" height="16" border="0" style="CURSOR: hand">
												</a>
											</td>
										</tr>
